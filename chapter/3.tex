...
%%
\begin{center}
  \input{img/3-1-differenzierbarkeit}
\end{center}
...
\begin{Dfn}[Regul"are Punkte, Submersion, Immersion]
  ...
  \item Es Punkt $p \in M$ hei"st \CmMark{regul"arer Punkt} von $\Phi$, wenn $\Phi_{*p}$ surjektiv ist. Ein Punkt $q \in N$ hei"st \CmMark{regul"arer Wert}, wenn jeder Punkt $p \in \Phi^{-1}(q)$ regul"ar ist.
