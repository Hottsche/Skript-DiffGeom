...
\begin{Dfn}
  ...
  Eine Kurve $\gamma$ heißt \CmMark{Geodätische}, falls sie lokal minimierende Geodätische ist, das hei"st für alle $t \in [a,b]$ existiert ein $\varepsilon > 0$, so dass $\gamma|_{[t-\varepsilon,t+\varepsilon]}$ minimierende Geodätische ist.
\end{Dfn}
