...
Ein Vektorbündel $E \xrightarrow{\pi} M$ heißt \CmMark{trivial}, wenn es einen Vektorbündelisomorphismus von $E$ auf $M \times \R^k$ gibt.
...
Es sei $(\tau_\alpha,U_{\alpha})_{\alpha \in J}$ eine Familie lokaler Trivialisierungen von $E$ mit $M = \bigcup_{\alpha \in J}U_{\alpha}$.
