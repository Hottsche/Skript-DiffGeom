...
\item
	...
	\item[Variante 2:]
		...
		Dann ist
		\begin{align*}
			\pi_{1*_p} \tilde X &= \sum_{k=1}^{\ddim M_1} \left( \sum_j \underbrace{\partial_j \left( \phi^k \circ \pi_1 \circ (\phi_1 \times \phi_2)^{-1} \right)}_{= \delta(k,j)} \left( \phi_1(p_1), \phi_2(p_2) \right) \xi^j \right) \pdifffrac[p_1]{}{\phi_1^k}\\
